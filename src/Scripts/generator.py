...
# f1 = open('PlanesFlights.csv', 'w', encoding='UTF-16')
# f1.write('PlaneId,FlightId\n')
# f2 = open('Tickets.csv', 'w', encoding='UTF-16')
# f2.write('Id,FlightId,Available,Row,Place,Class,Refund,Price\n')

# with open('Flights.csv', 'w', encoding='UTF-16') as f:
# 	f.write('Id,DeparturePoint,ArrivalPoint,DepartureDateTime,ArrivalDateTime\n')
...
# 		f.write(f'{i + 1},{departure_point},{arrival_point},{departure_date_time},{arrival_date_time}\n')
...
# 			f2.write(f'{ticket_id},{i + 1},{available},{row},{place},{class_name},{1},{r.randint(first_price_min, first_price_max)}\n')
# 			ticket_id += 1
# 			place_ind += 1
...
# 			f2.write(f'{ticket_id},{i + 1},{available},{row},{place},{class_name},{1},{r.randint(business_price_min, business_price_max)}\n')
# 			ticket_id += 1
# 			place_ind += 1
# 			if place_ind == len(places):
# 				place_ind = 0
...
# 			f2.write(f'{ticket_id},{i + 1},{available},{row},{place},{class_name},{1},{r.randint(economy_price_min, economy_price_max)}\n')
# 			ticket_id += 1
# 			place_ind += 1
# 			if place_ind == len(places):
# 				place_ind = 0
...
# 		f1.write(f'{plane_id},{i + 1}\n')

# f1.close()
# f2.close()

departure_date_time = d.datetime.now()
time_change = d.timedelta(minutes=1440)
arrival_date_time = departure_date_time + time_change
